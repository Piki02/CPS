<table>
    <thead>
        ...
        <tr>
            <th colspan="7" style="text-align: center; font-weight: bold; text-decoration: underline;">INVOICE
                #{{ $order->id }}</th>
        </tr>
        <tr>
            <th></th>
        ...
        <tr>
            <th colspan="7"
                style="border-left: 2px solid #000000; border-right: 2px solid #000000; border-top: 2px solid #000000; font-weight: bold;">
                Name: <span style="color: #000080;">{{ $order->invoice_name ?? 'N/A' }}</span>
            </th>
        </tr>
        <tr>
            <th colspan="7" style="border-left: 2px solid #000000; border-right: 2px solid #000000; font-weight: bold;">
                Address: <span style="color: #000080;">{{ $order->invoice_address }}</span>
            </th>
        </tr>
        <tr>
            <th colspan="7" style="border-left: 2px solid #000000; border-right: 2px solid #000000; font-weight: bold;">
                Phone: <span style="color: #000080;">{{ $order->invoice_phone }}</span>
            </th>
        </tr>
        <tr>
            <th colspan="7" style="border-left: 2px solid #000000; border-right: 2px solid #000000; font-weight: bold;">
                NIT: <span style="color: #000080;">{{ $order->invoice_nit }}</span>
            </th>
        </tr>
        <tr>
            <th colspan="7" style="border-left: 2px solid #000000; border-right: 2px solid #000000; font-weight: bold;">
                Zip Code: <span style="color: #000080;">{{ $order->invoice_zip_code }}</span>
            </th>
        </tr>
        <tr>
            <th colspan="7"
                style="border-left: 2px solid #000000; border-right: 2px solid #000000; border-bottom: 2px solid #000000; font-weight: bold; border-top: 1px dashed #ccc;">
