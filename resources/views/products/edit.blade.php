                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('name', $product->name) }}" required autofocus>
                        ...
                        <!-- Unit -->
                        <div class="mb-4">
                            <label for="unit" class="block text-gray-700 text-sm font-bold mb-2">{{ __('Unit') }}</label>
                        ...
                        <!-- Image -->
                        <div class="mb-6">
                            <label for="image" class="block text-gray-700 text-sm font-bold mb-2">{{ __('Product Image') }}</label>
                            @if($product->image_path)
                                <div class="mb-2">
                                    <img src="{{ asset($product->image_path) }}" alt="Current Image" class="h-20 w-20 object-cover rounded">
                                </div>
                            @endif
